...
DRIVE_DOCS_PATH = ROOT / "backend" / "runtime" / "google_drive_documents.json"
INDEX_PATH = ROOT / "backend" / "runtime" / "google_drive_embedding_index.json"
OUTPUT_PATH = ROOT / "backend" / "runtime" / "google_drive_retrieval_benchmark.json"
...
def main():
    ...
    print("=" * 100)
    print("GOOGLE DRIVE RETRIEVAL BENCHMARK")
    print("=" * 100)
